    ...
    <div class="create-api-container">
      ...
      <div class="content">
        ...
        <div class="nav-actions">
          <div class="button button-red"> Test </div>
          <div class="button button-green"> Save </div>
          <div class="button button-blue"> Add Node </div>
          <div class="button button-blue"> Actions </div>
        </div>
        ...
        <div class="node-container">
          ...
          <div class="node-details" v-for="(node) in graph.nodeMap" :key="node.nodeName">
            <template v-if="nodeSeen === 'node-'+key">
              <div class="heading">
              ...
              <div class="add-parameter-container">
                <div id="add-parameter" class="button button-blue" @click="addParam(node)"> Add Parameter </div>
              </div>
...
export default {
  ...
  methods: {
    addParam: function (node) {
      ...
      var newParameter = { 'parameterName': paramName, 'parameterType': '', 'parameterValue': '', 'referenceNodeName': '' }
